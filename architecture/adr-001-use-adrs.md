...
Crossroads has several very explicit goals that make the practice and
...
We will document every architecture-level decision for Crossroads and its
...
1. Developers must write an ADR and submit it for review before
   ...
   decision that affects the way Crossroads or a Crossroads application is
